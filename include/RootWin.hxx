...
public: // functions
	...
	bool hasWM_Pid() const { return m_wm_pid != cosmos::ProcessID::INVALID; }
	...
	cosmos::ProcessID getWM_Pid() const { return m_wm_pid; }
...
protected: // data
	...
	cosmos::ProcessID m_wm_pid = cosmos::ProcessID::INVALID;
